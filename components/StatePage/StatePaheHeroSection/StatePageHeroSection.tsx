...
const StatePageHeroSection = ({
  ...
  return (
    <div className="py-12 px-5 bg-[#BABABA]">
      <div className="container mx-auto md:pt-20 sm:pb-12 pt-12 pb-4">
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center justify-between gap-4">
          <div>
            ...
            <div className="relative md:my-0 mt-5 w-full inline-grid justify-center md:justify-start md:mt-10">
