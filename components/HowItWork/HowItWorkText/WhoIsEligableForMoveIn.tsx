...
const WhoIsEligableForMoveIn = async () => {
    let pageContent: HowItWorksContentProps | null = null;

    try {
        pageContent = await howItWorksService.fetchOverviewSection("who-is-eligible-for-the-move-in-bonus");
    } catch (error) {
...
export default WhoIsEligableForMoveIn;