                        ...
                        <tbody>
                            {moveInBonus?.bonusTable.map((row, index) => (
                                <tr key={index} className="border">
                                    <td className="text-[#000000] roboto lg:text-[24px] md:text-[24px] sm:text-[20px] text-[20px] font-bold p-3">{row.priceRange}</td>
                                    <td className="text-[#000000] roboto lg:text-[24px] md:text-[24px] sm:text-[20px] text-[20px] font-medium p-3">{row.moveInBonus.toLocaleString()}</td>
                                    <td className="text-[#000000] roboto lg:text-[24px] md:text-[24px] sm:text-[20px] text-[20px] font-medium p-3">{row.charityDonation.toLocaleString()}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
