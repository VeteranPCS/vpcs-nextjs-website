...
const HowItWorksForAgent = async () => {
    let pageContent: HowItWorksContentProps | null = null;

    try {
        pageContent = await howItWorksService.fetchOverviewSection("how-it-works-for-agents");
    } catch (error) {
        console.error("Error fetching the How It Works for Agent Content", error);
    }
...
export default HowItWorksForAgent;