          ...
          <div className="container mx-auto px-5">
            <div className="grid lg:grid-cols-2 grid-cols-1 items-start justify-between gap-6 mb-6">
              <div className="mx-auto text-left w-full order-2 md:order-none">
                <h1 className="text-white font-bold lg:text-[59px] md:text-[29px] text-[40px] poppins leading-[1.3]">
                  {pageData?.header}
                </h1>
                <p className="md:text-[18px] text-[16px] font-normal text-white poppins sm:mb-10 mb-5 mt-4 leading-[26px]">
