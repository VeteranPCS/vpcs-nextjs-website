        ...
        <div className="container mx-auto px-5">
          <div className="grid lg:grid-cols-2 grid-cols-1 items-start justify-between gap-4">
            <div className="mx-auto text-left w-full order-2 md:order-none">
              <h1 className="text-white font-bold lg:text-[59px] md:text-[29px] text-[32px] poppins mb-5 leading-[1.3] lg:w-[700px] md:w-[500px] w-full">
                Kickstart Your Career in Real Estate!
              </h1>
              <p className="md:text-[18px] text-[16px] font-normal text-white poppins mb-10 lg:w-[650px] md:w-[500px] w-full">
