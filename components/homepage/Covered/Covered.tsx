...
const Covered = () => {
  ...
  return (
    <div className="container mx-auto w-full lg:py-16 md:py-16 sm:py-16 py-0">
      ...
      <div
        className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 lg:mt-20 md:mt-10 sm:mt-10 mt-10 justify-center xl:gap-10 lg:gap-10 md:gap-10 sm:gap-2 gap-2 xl:px-10 lg:px-10 md:px-10 sm:px-3 px-3"
        data-aos="fade-left"
        data-aos-duration="1000"
      >
