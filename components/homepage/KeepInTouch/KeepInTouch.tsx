        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 justify-center md:gap-10 gap-2 md:px-10 px-3">
          ...
          <div className="mt-5 md:mt-0">
            <div className={classes.CustomResponsiveCenter}>
              ...
              >
                <h2 className="lg:text-[36px] text-[25px] poppins font-bold text-primary md:text-left text-center">
                  Keep In Touch
                </h2>
                <p className="text-primary font-bold lg:text-[21px] text-[15px] roboto mb-6 md:text-left text-center">
                ...
                <p className="text-primary roboto text-xs lg:text-sm max-w-[390px] sm:max-w-full mx-auto font-medium mb-3 text-left md:pl-0 pl-3">
                  Fields marked with an asterisk (*) are required.
                </p>
                <HoneypotField ref={honeypotRef} />
                <div className="flex items-center md:pl-0 pl-3 max-w-[390px] mx-auto sm:max-w-full">
