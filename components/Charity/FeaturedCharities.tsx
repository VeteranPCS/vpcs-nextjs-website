                ...
                <div className="flex flex-col md:flex-row items-center justify-center py-10 md:py-20">
                    <div className="w-full md:w-1/2 flex justify-center">
                        <Image
                            width={400}
                            height={400}
                            src={"/assets/service-dogs-charity.webp"} // Placeholder, replace with actual image if available
                    ...
                    <div className="w-full md:w-1/2 mt-10 md:mt-0">
                        <div>
                            <Image
                                width={273}
                                height={63}
                                src={"/assets/freedom-service-dogs-logo.webp"} // Placeholder, replace with actual logo if available
