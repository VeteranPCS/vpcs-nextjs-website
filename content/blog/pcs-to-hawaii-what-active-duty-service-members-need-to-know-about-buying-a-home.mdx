...
For more on making the move, see our overview of [the military bases in Hawaii](/blog/what-military-bases-are-in-hawaii) and our guide on [whether active duty military should buy a home in Hawaii](/blog/should-active-duty-military-buy-a-home-in-hawaii). Moving with animals means planning early, so read [PCS to Hawaii with pets](/blog/pcs-to-hawaii-with-pets). Because Hawaii is an OCONUS move, our guide to [what to do with your home when you PCS OCONUS](/blog/pcsing-oconus-what-do-i-do-with-my-home) is worth a look, and if you plan to finance, review [the benefits of a VA loan](/blog/what-are-the-benefits-of-a-va-loan).

To talk through your options on Oahu, you can <AgentContactLink salesforceId="0014x00000IFGiV" stateSlug="hawaii">connect with a VeteranPCS agent in Hawaii</AgentContactLink>.

<AgentCTA salesforceId="0014x00000IFGiV" name="Erica Lehmkuhl" stateSlug="hawaii" />
