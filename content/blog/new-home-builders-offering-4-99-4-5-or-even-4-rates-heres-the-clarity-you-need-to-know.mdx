...
- Your exit strategy should include **rental potential**—can the home generate enough rental income to cover your mortgage if you need to move? Just remember the [VA loan occupancy rules](/blog/va-loan-occupancy-requirements-pcs): you live in the home first, then PCS orders let you rent it out later.
