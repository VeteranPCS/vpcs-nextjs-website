...
export default function OnboardingWelcome({ firstName }: OnboardingWelcomeProps) {
  return (
    <Html>
      <Head />
      <Preview>Welcome to VeteranPCS - Thank You for Your Application</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.text}>
            Thank you for your interest in joining the VeteranPCS network! We're excited to learn
            more about you and how we can work together to serve military families.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            real estate professionals. Our agents understand VA loans, PCS moves, and the unique
          ...
          <Text style={styles.text}>
            2. <strong>Brief Interview</strong> - We'll schedule a quick call to learn more about
            your experience
          </Text>
