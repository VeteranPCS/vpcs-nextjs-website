      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.text}>
            ...
            from veterans and military families in your area.
          </Text>
          ...
          <Text style={styles.text}>
            Please take a moment to review your profile on our website and let us know if anything
            needs to be updated.
          </Text>
          ...
          <Text style={styles.text}>
            <strong>Leads:</strong> When a veteran or military family in your area requests an
            agent, you'll receive an email with their contact information. Please respond
          ...
          <Text style={styles.text}>
            1. <strong>Respond Quickly</strong> - The first agent to respond often wins the client
          </Text>

          <Text style={styles.text}>
            2. <strong>Be Knowledgeable</strong> - Brush up on VA loan requirements and
          ...
          <Text style={styles.sectionHeading}>TEST YOUR LEAD FLOW</Text>

          <Text style={styles.text}>
            Want to see how leads come through? Visit your profile page and submit a test inquiry
            to yourself. This helps you understand the customer experience.
          </Text>
