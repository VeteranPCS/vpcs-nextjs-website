...
export default function OnboardingFollowUp({ firstName }: OnboardingFollowUpProps) {
  return (
    <Html>
      <Head />
      <Preview>Following Up on Your VeteranPCS Application</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.text}>
            We wanted to follow up on your VeteranPCS application. We haven't heard from you in a
            little while and wanted to make sure our previous email didn't get lost in your inbox.
          </Text>
          ...
          <Text style={styles.text}>
            You started an application to join the VeteranPCS agent network. We'd love to move
            forward with the process and learn more about how you serve military families.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            looking for agents{'\n'}
            - <strong>Featured Listings:</strong> Be prominently displayed on our state and area
            pages{'\n'}
