...
const jsonLd: WithContext<RealEstateAgent> =
{
    ...
    knowsAbout: [
        ...
        "military spouse real estate agents",
        "VA loan",
        "VA loan eligibility",
        "VA rehab loans",
    ...
    areaServed: [
        ...
        { "@type": "AdministrativeArea", name: "All 50 U.S. states" },
        { "@type": "Place", name: "OCONUS military installations (overseas assignments)" },
    ],
    serviceArea: {
        "@type": "AdministrativeArea",
        name: "All 50 U.S. states and OCONUS",
    },
